...
var command_class_1 = require("./command.class");
...
var StartCommand = /** @class */ (function (_super) {
    ...
    StartCommand.prototype.handle = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ctx.deleteMessage();
                        return [4 /*yield*/, ctx.reply('Привет, что интересует?', telegraf_1.Markup.keyboard([
                                [
        ...
        this.bot.hears('Цены', function (ctx) {
            ctx.editMessageText('Выбери категорию:');
        });
        this.bot.hears('Клиенты', function (ctx) {
        });
